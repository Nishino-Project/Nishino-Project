  ...
  return new Promise(async(resolve, reject) => {
    ...
    .then(({ data }) => {
      ...
      var result = {
        coder: 'rem-comps',
        result: results,
        warning: 'It is strictly forbidden to reupload this code, copyright © 2022 by rem-comps'
      };
  ...
  return new Promise(async(resolve, reject) => {
    ...
    .then(({ data }) => {
      ...
      var result = {
        coder: 'rem-comps',
        result: results,
        warning: 'It is strictly forbidden to repackage this web API into another web API, copyright © 2022 by rem-comps'
      };
      var $ = cheerio.load(data);
      $('div.pb12 > table.top-ranking-table').each(function(y,z) {
        for(let i = 0; i < 7; i++){
  ...
  return new Promise(async(resolve, reject) => {
    ...
    .then(({ data }) => {
      ...
      var result = {
        coder: 'rem-comps',
        result: results,
        warning: 'It is strictly forbidden to repackage this web API into another web API, copyright © 2022 by rem-comp'
      };
      var $ = cheerio.load(data);
